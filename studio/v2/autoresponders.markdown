...
| trigger                                 | The type of action that this autoresponder triggers on                                                         | "subscription", "campaign_open", "autoresponder_open" | String  |
...
| trigger_autoresponder_to_open_id        | If this autoresponder's trigger is `autoresponder_open`, the autoresponder it will trigger on                  | 123                                                   | Integer |
