...
| trigger                                 | The type of action that this autoresponder triggers on                                                         | "subscription", "campaign_open", "autoresponder_open", "autoresponder_nonopen", "autoresponder_send" | String  |
...
| trigger_campaign_to_open_id             | The ID of the campaign that when opened will cause this autoresponder to trigger. Only valid if `trigger` is equal to `campaign_open`.   | null                                                  | Integer |
| trigger_autoresponder_to_open_id        | The ID of the autoresponder that when opened (or not opened) will cause this autoresponder to trigger. Only valid if `trigger` is equal to `autoresponder_open` or `autoresponder_nonopen`.      | 123                                                   | Integer |
