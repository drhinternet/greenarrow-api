...
| segmentation_criteria_name          | The name of this segment, if it is saved to the mailing list. If this is an anonymous segment used for just this campaign, this value will be null.                                     | `"My Super Subscribers"`        | String   |
| segmentation_criteria_remote_sql    | The SQL to use when querying the remote database for this campaign. This only applies to [Remote Lists](../remote_lists.markdown).                                                      | `"select * from table"`         | String   |
| dispatch                            | Inline object containing delivery settings of the Campaign; Comes from the server only if delivery settings of the Campaign are defined                                                 | {}                              | Hash     |
| dispatch.state                      | The state of delivery; Can be one of: "idle", "scheduled", "sending", "finished", "failed", "cancelled"                                                                                 | "failed"                        | String   |
| dispatch.state_description          | Localized textual description of the state                                                                                                                                              | "Step 2: Scheduled"             | String   |
...
| stat_summary.scomps_status_updated  | Number of recipients where the status was updated to status 'scomp' (See 1 below).                                                                                                      | 1                               | Integer  |
...
| stat_summary.unsubs_status_updated  | Number of recipients where the status was updated to status 'unsubscribed' (See 1 below).                                                                                               | 1                               | Integer  |
| stat_summary.bounces_status_updated | Number of recipients where status was updated to status 'bounce' (See 1 below).                                                                                                         | 1                               | Integer  |
...
| campaign.segmentation_criteria_remote_sql                           | The SQL to use when querying the remote database for this campaign. This only applies to [Remote Lists](../remote_lists.markdown).      | `"select * from local_recipient_list"`                                                                                 | String   |
